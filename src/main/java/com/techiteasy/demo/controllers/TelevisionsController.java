...
public class TelevisionsController {
    ...
    public ResponseEntity<List<Television>> getAllTelevisions() {
        return ResponseEntity.ok(televisionService.getAllTelevisions()); //hier worden alle waarden (details van tv's uit de 'Map' gehaald met 'televeision.values()' en omgezet in een ArrayList. Dit geeft een lijst van tv's terug - ResponseEntity.ok voor lijst van tv's
    }
...
//}
    ...
    public ResponseEntity<Television> createTelevision(@RequestBody Television television) {
       ...
       // televisionDataBase.add(televisionDetails);
        return ResponseEntity.created(null).body(televisionService.createTelevision(television)); //ResponseEntity.created bij succesvolle creatie
    }
